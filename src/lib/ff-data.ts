...
export const ffOrders: FFOrder[] = [
  { id: "FFO-001", buyer: "Aiman Razak", buyerEmail: "aiman.razak@loreal.com", department: "Marketing", product: "L'Oréal Paris Revitalift Hyaluronic Acid Serum 30ml", sku: "LOR-SER-002", quantity: 2, unitPrice: 9.96, totalAmount: 19.92, channel: "Online", status: "Shipped", date: "2026-04-28", time: "09:15" },
...
export const ffAccessConfig: FFAccessConfig = {
  ...
  bazaarEnabled: true,
  bazaarLocation: "L'Oréal Malaysia HQ — Lobby Level, Hall B",
